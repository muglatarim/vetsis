-- =====================================================================
-- VETSİS — Tür Filtresini Eski Haline Düşürme Yaması
-- Dosya: 13_revert_filter.sql
-- =====================================================================

-- İsteğiniz üzerine haritadaki sürülerin gizlenmesi iptal edildi.
-- Bir işletmenin 1 tane bile ineği varsa, sürünün kendisi koyun olsa dahi 
-- (sığır kampanyasında) haritada gözükecektir.
...
BEGIN
  ...
  WHERE
    ...
    -- ESKİ KOD (GERİ ALINDI): İşletmenin hayvan sayısı hedeflenen sayıdan büyükse Göster!
    AND (
